...
public:
    ...
    virtual std::pair<ParticleID, Particle> const& _get_particle(const size_t idx) const = 0;
    ...
    virtual bool _check_particles_within_radius(
        const Real3& pos, const Real& radius, const ParticleID& ignore) const = 0;
